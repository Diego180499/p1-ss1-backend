...
CREATE TABLE commerce.promotions (
    id SERIAL PRIMARY KEY,
    group_type_id INT NOT NULL REFERENCES commerce.grouping_types (id),
...
CREATE TABLE commerce.promoted_cds (
    promotion_id INT NOT NULL REFERENCES commerce.promotions (id),
    cd_id INT NOT NULL REFERENCES catalog.cds (id)
);
...
CREATE TABLE commerce.order_items (
    ...
    discography_id INT NULL REFERENCES catalog.discography (id),
    promotion_id INT NULL REFERENCES commerce.promotions (id),
